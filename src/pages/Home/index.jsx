...
import { Card, RestaurantCard, Modal, Map, Loader, Skeleton } from '../../componentes';
...
const Home = () => {
    ...
    <TextField
       ...
       <Carousel { ... settings}>
           ...
           <Card 
           key={restaurant.place_id} photo={restaurant.photos ? restaurant.photos[0].getUrl() : restaurante} title={restaurant.name} />
           ))}
